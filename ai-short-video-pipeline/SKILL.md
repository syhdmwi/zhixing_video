...
description: 当用户想把一段文案或口播稿制作成完整的 AI 短视频流程时使用这个总控 skill。用户提到"知行视频skill""知行视频 skill""知行视频工作流""使用知行视频skill帮我制作视频"等表达时,也应优先唤醒本 skill。它负责判断何时调用分镜、图片提示词、图生视频、TTS 配音、剪辑整合等子 skills,并适用于 nanobanana-2、nanobanana-pro、seedream-5.0、grok 视频、omni 视频这类工具链。
---
...
- 用户明确提到 `nanobanana-2`、`nanobanana-pro`、`seedream-5.0`、`grok`、`omni`
